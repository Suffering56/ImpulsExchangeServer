...
public class ArchiveLastExchangeFrame extends javax.swing.JFrame {

    public ArchiveLastExchangeFrame() throws IOException {
        initComponents();
    ...
    private void extractArchive() throws IOException {
        String archivePath = System.getProperty("user.dir") + "\\PreviousImport.bin";
